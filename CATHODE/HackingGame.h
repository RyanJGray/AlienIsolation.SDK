...
namespace CATHODE::HackingGame
{
	...
	inline auto on_custom_method = reinterpret_cast<t_on_custom_method>(AI_SDK_RELATIVE_ADDRESS(0x00518cd0));
	...
	inline auto trigger_win = reinterpret_cast<t_trigger_win>(AI_SDK_RELATIVE_ADDRESS(0x004d2990));
}
